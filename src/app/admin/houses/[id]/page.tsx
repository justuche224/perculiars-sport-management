...
export default async function HouseDetailsPage({
  ...
  const houseRank = allHouses
    ? allHouses.findIndex((h) => h.id === house.id) + 1
    : 0;
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mt-2">
            House team details and management
          </p>
        </div>
        <Button asChild>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              All registered participants for this house
            </CardDescription>
          </CardHeader>
          <CardContent>
            {house.participants && house.participants.length > 0 ? (
              <div className="space-y-3">
                {house.participants.map((participant: Participant) => (
                  <div
                    key={participant.id}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest competition results for this house
            </CardDescription>
          </CardHeader>
          <CardContent>
