    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage house teams and assign captains</p>
        </div>
        <Button asChild>
        ...
        {houses?.map((house) => (
          <Card key={house.id} className="hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Captain: {house.captain?.full_name || "Not assigned"}</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      {(!houses || houses.length === 0) && (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Get started by creating your first house team.</p>
            <Button asChild>
              <Link href="/admin/houses/new">
                <Plus className="h-4 w-4 mr-2" />
                Add House
